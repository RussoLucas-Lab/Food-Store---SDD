...
Migrado desde tests/test_categoria_schema.py.
...
class TestCategoriaCreateRequest:
    ...
    def test_create_nombre_caracteres_permitidos(self):
        """Nombres con caracteres basicos permitidos pasan"""
        req = CategoriaCreateRequest(nombre="Bebidas Frias 1")
        assert req.nombre == "Bebidas Frias 1"
