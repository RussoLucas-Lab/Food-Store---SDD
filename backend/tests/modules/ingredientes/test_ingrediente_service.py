...
Migrado desde backend/tests/test_ingrediente_service.py.
...
class TestUpdateIngrediente:
    ...
    def test_update_ingrediente_valid(self, service, mock_uow):
        ...
        mock_uow.ingredientes.find_by_id.return_value = mock_ing
        mock_uow.ingredientes.find_by_name.return_value = None
...
class TestListIngredientes:
    ...
    def test_list_ingredientes_no_filters(self, service, mock_uow):
        ...
        mock_uow.ingredientes.list_active.return_value = [mock_ing1, mock_ing2]

        result = service.list_ingredientes()

        assert len(result) == 2
        mock_uow.ingredientes.list_active.assert_called_once()
    ...
    def test_list_ingredientes_with_filters(self, service, mock_uow):
        ...
        mock_uow.ingredientes.list_active.return_value = [mock_ing]
        ...
        assert len(result) == 1
        call_kwargs = mock_uow.ingredientes.list_active.call_args[1]
